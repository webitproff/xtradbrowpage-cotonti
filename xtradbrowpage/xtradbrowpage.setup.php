...
/**
 * xtradbrowpage.setup.php - Register data in $db_core and $db_config. Setup & Config File for the Plugin xtradbrowpage
 *
 * xtradbrowpage plugin for Cotonti 0.9.26, PHP 8.4+
 * Filename: xtradbrowpage.setup.php
 *
 * Date: Apr 25Th, 2026
